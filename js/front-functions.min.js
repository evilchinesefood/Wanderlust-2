...
function submitcharacter() {
	var inputname = $("#name");
  	if (inputname.val().length > 0) {
    	if (points == 0) {
				var name = $("#name").val();
				window.location.href = "new-game.php?name=" + name + "&str=" + str_value + "&int=" + int_value + "&sta=" + sta_value + "&agi=" + agi_value;
			} else {
...
function animateParchment(switchContents) {
	...
	if (switchContents !== null || switchContents !== 0) {
		window.setTimeout(function() { $('.parchment-inner').html(switchContents); },1000);
	}
